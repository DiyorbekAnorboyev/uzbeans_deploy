    ...
    <div className="max-w-sm w-full rounded-lg overflow-hidden shadow-lg border border-gray-200">
      ...
      <div className="flex items-start pl-2">
        <div className="flex items-start">
          {/* Green Indicator Bar */}
          <div className="h-full w-2 mt-2 bg-green-600"><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br></div>
          ...
          <div className="p-4">
            ...
            <ul className="mt-2 text-sm sm:text-base text-gray-700 space-y-1">
              ...
              {purity && (
                <li>
                  <span className="font-semibold">Purity:</span> {purity}
                </li>
              )}
              {moisture && (
                <li>
              ...
              {admixtures && (
                <li>
                  <span className="font-semibold">Admixtures:</span> {admixtures}
                </li>
              )}
              {imperfect && (
                <li>
                  <span className="font-semibold">Imperfect:</span> {imperfect}
                </li>
              )}
              {packageCard && (
                <li>
                  <span className="font-semibold">Package:</span> {packageCard}
                </li>
              )}
            </ul>
          </div>
